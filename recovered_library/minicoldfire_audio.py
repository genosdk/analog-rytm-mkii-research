...
def run_cli():
    ...
    ap.add_argument('main',nargs='?',type=Path,default=Path('research/extracted_stock_nrv/section_3_id_3.decompressed.bin'))
    ap.add_argument('--steps',type=int,default=100000)
    ap.add_argument('--json',type=Path,default=Path('build/minicoldfire_audio_run.json'))
    a=ap.parse_args()
