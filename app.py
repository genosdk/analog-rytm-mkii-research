...
STATUS = {
    ...
    "active_target": "close full-callback hardware timing for the post-BR Filter 2 hook",
    "completed": [
        ...
        "nonzero fixed-stage and outbound DMA bypass identity under a synthetic runtime fixture",
    ],
    "next": [
        "measure the full callback and exact board clock on hardware",
        "replace the synthetic mixer fixture with project-loaded runtime state",
