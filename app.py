...
STATUS = {
    ...
    "active_target": "trace proven BR output into the final sample-format/DAC handoff",
    "completed": [
    ...
    "next": [
        "map post-quantizer words into the final sample-format/DAC handoff",
        "measure a cycle-safe digital Filter 2 insertion boundary",
