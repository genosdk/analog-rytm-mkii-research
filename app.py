...
STATUS = {
    ...
    "active_target": "measure the post-BR Filter 2 hook and prove an exact bypass",
    "completed": [
    ...
    "next": [
        ...
        "prove a disabled Filter 2 hook is bit-identical",
