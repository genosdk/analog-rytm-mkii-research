...
static void elektron_ar_mk2_init(MachineState *machine)
{
    ...
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_TRANSFORM_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_TRANSFORM_TCG_DEFER");

        env->ar_audio_transform_accel = accel && *accel && strcmp(accel, "0");
    ...
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_EMAC32_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_EMAC32_TCG_DEFER");

        env->ar_audio_emac32_accel = accel && *accel && strcmp(accel, "0");
        env->ar_audio_emac32_control = env->ar_audio_emac32_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_POLYPHASE32_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_POLYPHASE32_TCG_DEFER");

        env->ar_audio_polyphase32_accel =
            accel && *accel && strcmp(accel, "0");
        env->ar_audio_polyphase32_control =
            env->ar_audio_polyphase32_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_MIX32_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_MIX32_TCG_DEFER");

        env->ar_audio_mix32_accel = accel && *accel && strcmp(accel, "0");
        env->ar_audio_mix32_control = env->ar_audio_mix32_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_POLYPHASE32B_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_POLYPHASE32B_TCG_DEFER");

        env->ar_audio_polyphase32b_accel =
            accel && *accel && strcmp(accel, "0");
        env->ar_audio_polyphase32b_control =
            env->ar_audio_polyphase32b_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_MIX32B_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_MIX32B_TCG_DEFER");

        env->ar_audio_mix32b_accel = accel && *accel && strcmp(accel, "0");
        env->ar_audio_mix32b_control = env->ar_audio_mix32b_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_MIX32C_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_MIX32C_TCG_DEFER");

        env->ar_audio_mix32c_accel = accel && *accel && strcmp(accel, "0");
        env->ar_audio_mix32c_control = env->ar_audio_mix32c_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_MIX32D_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_MIX32D_TCG_DEFER");

        env->ar_audio_mix32d_accel = accel && *accel && strcmp(accel, "0");
        env->ar_audio_mix32d_control = env->ar_audio_mix32d_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_MIX32E_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_MIX32E_TCG_DEFER");

        env->ar_audio_mix32e_accel = accel && *accel && strcmp(accel, "0");
        env->ar_audio_mix32e_control = env->ar_audio_mix32e_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_MIX32F_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_MIX32F_TCG_DEFER");

        env->ar_audio_mix32f_accel = accel && *accel && strcmp(accel, "0");
        env->ar_audio_mix32f_control = env->ar_audio_mix32f_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_MIX32G_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_MIX32G_TCG_DEFER");

        env->ar_audio_mix32g_accel = accel && *accel && strcmp(accel, "0");
        env->ar_audio_mix32g_control = env->ar_audio_mix32g_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_EMAC256_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_EMAC256_TCG_DEFER");

        env->ar_audio_emac256_accel = accel && *accel && strcmp(accel, "0");
        env->ar_audio_emac256_control = env->ar_audio_emac256_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_SCALAR49_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_SCALAR49_TCG_DEFER");

        env->ar_audio_scalar49_accel = accel && *accel && strcmp(accel, "0");
        env->ar_audio_scalar49_control = env->ar_audio_scalar49_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
    {
        const char *accel = g_getenv("AR_MK2_AUDIO_EMAC2X4_TCG");
        const char *defer = g_getenv("AR_MK2_AUDIO_EMAC2X4_TCG_DEFER");

        env->ar_audio_emac2x4_accel = accel && *accel && strcmp(accel, "0");
        env->ar_audio_emac2x4_control = env->ar_audio_emac2x4_accel &&
            !(defer && *defer && strcmp(defer, "0"));
    }
