...
static void write_report(bool complete)
{
    ...
    fprintf(report_file,
            ...
            candidate_tcg_mix32b ? "tcg-mix32b" : "native-shadow",
        ...
        if (candidate_tcg || candidate_tcg_transform || candidate_tcg_outer ||
            ...
            candidate_executed =
                (candidate_tcg ? read_tcg_control(&control) :
                 ...
                 read_tcg_mix32b_control(&control)) && control == 0;
                                           ...
                                           int argc, char **argv)
{
    ...
    if ((candidate_inner + candidate_tcg + candidate_transform +
         ...
         candidate_mix32b + candidate_tcg_mix32b + runtime_inner) > 1) {
